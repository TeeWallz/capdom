...
<div class="container mx-auto my-12 px-2 md:px-4">
	<section class="mb-32">
		<div class="px 4 mx-auto py-8">
			<div class="container text-4xl font-bold">
				{@html $t('navigation.contact_us')}
				<div class="my-4 h-2 w-full bg-primary"></div>
			</div>
		</div>
		...
		<div class="flex flex-wrap">
			<form class="mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6">
				<div class="mb-3 w-full">
					<label class="mb-[2px] block font-medium text-primary-dark" htmlFor="exampleInput90">
						Name
					</label>
					<input
						type="text"
						class="w-full rounded-md border px-2 py-2 outline-none"
						id="exampleInput90"
						placeholder="Name"
					/>
				</div>
				...
				<div class="mb-3 w-full">
					...
					<textarea class="w-full rounded-[5px] border px-2 py-2 outline-none" name="" id=""
					></textarea>
				</div>

				<button
					type="button"
					class="mb-6 inline-block w-full rounded bg-primary px-6 py-2.5 font-medium uppercase leading-normal text-white hover:bg-primaryLight hover:shadow-md"
				>
					Send
				</button>
			</form>
				...
				<div class="flex flex-wrap">
					<div class="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
						<div class="flex items-start">
							<div class="shrink-0">
								<div class="bg-teal-400-100 inline-block rounded-md p-4 text-primary-dark">
									<svg
